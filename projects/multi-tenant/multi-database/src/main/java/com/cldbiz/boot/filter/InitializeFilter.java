package com.cldbiz.boot.filter;
...
import com.cldbiz.boot.util.SessionUtil;
...
public class InitializeFilter implements Filter {
	...
	private void setAfwExecutionContext(HttpServletRequest request, HttpServletResponse response) {
		UserProfileDto userProfileDto = SessionUtil.getUserProfileDto(request);
		BootExecutionContext.setUserProfileDto(userProfileDto);
	}
}
