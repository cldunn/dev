...
import com.cldbiz.angularSpring.hibernate.CustomPhysicalNamingStrategy;
...
public class HibernateDDLExporter {
    ...
    public HibernateDDLExporter schemaExport() throws Exception {
        ...
        ServiceRegistry serviceRegistry = new StandardServiceRegistryBuilder()
                ...
                .applySetting(AvailableSettings.PHYSICAL_NAMING_STRATEGY, CustomPhysicalNamingStrategy.class)
                .build();
